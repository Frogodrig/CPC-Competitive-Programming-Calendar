  ...
  return (
    <header>
      <h1>
        ...
        &nbsp;CP Calendar
        <a className={'header-links'} href={"https://github.com/Frogodrig/CPC-Competitive-Programming-Calendar"} target={"_blank"} rel={'noreferrer'}><GitHubIcon fontSize="large" /></a>
